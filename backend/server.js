...
async function chat(){
    const response = await openai.createChatCompletion({
        ...
        {role:"user",content: "Hey my name is Tyriq. Nice to meet you. I like basketball, anime, video games, and chess. My organization Satellite proposal just got accepted by NASA. I also like programming websites and a follower of Jesus Christ. Can you please give me a power and compliment me?"}],
        max_tokens:1000,
      });
