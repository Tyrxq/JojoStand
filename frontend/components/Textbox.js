...
const Textbox = ({submit,func,loading,pics}) => {
  return (
    <form className = {pics.length === 0 ? "text-container-nothing" : "text-container"} onSubmit = {submit}>
        ...
        <button id = {pics.length === 0 ? "text-button-nothing" : "text-button"} type = "submit"><span class="material-symbols-outlined">mediation</span> </button>
